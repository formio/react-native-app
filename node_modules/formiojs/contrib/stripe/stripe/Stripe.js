...
if (typeof _Validator2.default.validators.stripe === 'undefined') {
  _Validator2.default.validators.stripe = {
    key: 'validate.stripe',
...
var StripeComponent = function (_BaseComponent) {
  ...
  function StripeComponent(component, options, data) {
     ...
     * @type {Promise}
     */
    _this.stripeReady = _Formio2.default.requireLibrary('stripe', 'Stripe', src, true);
