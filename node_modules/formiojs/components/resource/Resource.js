...
var ResourceComponent = function (_SelectComponent) {
  ...
  _createClass(ResourceComponent, null, [{
    ...
    value: function schema() {
      ...
      return _Select2.default.schema.apply(_Select2.default, [{
        type: 'resource',
        label: 'Resource',
        key: 'resource',
        dataSrc: 'resource',
  ...
  _createClass(ResourceComponent, [{
    ...
    value: function addButton() {
      ...
      this.addEventListener(addButton, 'click', function (event) {
        ...
        var form = new _Webform2.default(formioForm);
        form.on('submit', function (submission) {
          _this2.setValue(submission);
          dialog.close();
        });
        form.src = _lodash2.default.get(_this2.root, 'formio.projectUrl', _Formio2.default.getBaseUrl()) + '/form/' + _this2.component.resource;
      });
